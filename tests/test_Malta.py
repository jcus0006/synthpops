...
pars = sc.objdict(
    ...
    tourism = True,
    beds_staff_hotel_ratio = 0.83, # avg 12 staff per 10 beds (or 1.2 staff per bed): https://www.city-of-hotels.com/165/hotel-staff-en.html#:~:text=According%20to%20the%20recommendations%20of,5%20star%20hotel%20%E2%80%93%2020%20person.
    beds_staff_non_hotel_ratio = 8, # 1 staff to 8 beds (assumption)
    use_default      =  True,
